...
//        showFoto()
    ...
    fun setDefaultValue(): Array<Any> {
        ...
        Log.e("penyakit_bawaan", penyakit_bawaan)
        binding.ChkEditDiabetes.isChecked = false
        binding.ChkEditJantung.isChecked = false
        binding.ChkEditAsma.isChecked = false

        val penyakit = penyakit_bawaan.split("|").toTypedArray()
        for (p in penyakit) {
            if (p.equals("diabetes")) {
                binding.ChkEditDiabetes.isChecked = true
            } else if (p.equals("jantung")) {
                binding.ChkEditJantung.isChecked = true
            } else if (p.equals("asma")) {
    ...
    fun showFoto(nik: String, nama: String) {
//        val intent = intent
//        val nik = intent.getStringExtra("nik").toString()
//        val nama = intent.getStringExtra("nama"). toString()
